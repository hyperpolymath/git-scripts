...
Elixir-based TUI for managing reusable scripts and repository
maintenance tasks across the hyperpolymath estate. Provides wiki audits,
branch protection enforcement, README standardisation, mass repo
updates, and GitHub CLI utilities via a script manager interface.
